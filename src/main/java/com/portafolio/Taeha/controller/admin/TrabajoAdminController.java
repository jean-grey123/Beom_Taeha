...
public class TrabajoAdminController {
    ...
    // INICIO DE TRABAJOS
    // =========================================================
    // Esta ruta se ejecuta cuando presionas "Trabajos"
    // en el sidebar:
    //
    // /admin/trabajos
    //
    // Muestra las semanas para poder seleccionar una.
    // =========================================================
    ...
    public ResponseEntity<Resource> verArchivo(
        ...
        if (nombreMinuscula.endsWith(".pdf")) {
            ...
            tipo = MediaType.parseMediaType("application/msword");
            ...
            tipo = MediaType.parseMediaType("application/vnd.ms-excel");
